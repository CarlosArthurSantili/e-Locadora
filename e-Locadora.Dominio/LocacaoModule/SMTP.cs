...
namespace e_Locadora.Email
{
    public class SMTP
    {
        ...
        public void enviarEmail(string para, string cc, string cco, string subject, string body)
        {
            using (System.Net.Mail.SmtpClient smtp = new System.Net.Mail.SmtpClient())
            {
                smtp.Host = "smtp.gmail.com";
        ...
        public void enviarEmail(string emailCliente, string subject, string body)
        {
